...
# TEST_DIR=/Users/asterisk/Library/Android/sdk/ndk-bundle2
# TEST_RESULT=$(dir_is_exist ${TEST_DIR})
# echo ${TEST_RESULT}
...
dir_is_exist2 "${DEVELOPER}ssss"



# ref: https://stackoverflow.com/questions/17336915/return-value-in-a-bash-function
# error
# function fun1(){
#   return 34
# }
...
# ref: https://linuxhint.com/return-string-bash-functions/
# function F2()
# {
